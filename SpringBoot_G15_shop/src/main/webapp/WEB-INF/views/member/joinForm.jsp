...
<form id="join" action="join" method="post" name="formm">
	...
	<fieldset>
        ...
        <label>Zip Code</label><input type="text" id="sample6_postcode" name="zip_num" readonly>      
        <input type="button" value="우편번호 찾기" class="dup" onclick="sample6_execDaumPostcode()"><br>
        <label>Address</label>
        <input type="text" id="sample6_address" name="address1" size="50" value="${dto.address1}" readonly><br>
        <label>detailAddress</label>
        <input type="text" id="sample6_detailAddress" name="address2" size="50" value="${dto.address2}"><br>
        <label>extraAddress</label>
        <input type="text" id="sample6_extraAddress" name="address3" value="${dto.address3}">
